...
const AddProducts = () => {
    ...
    async function submitProduct(values) {
        ...
        try {
            ...
            setLoading(false);
            toast.success("Product added...please wait redirecting to your product page", {
                position: "top-center",
                autoClose: 3000,
                    ...
                    <div className="prod_add">
                        <div className="form">
                            <Form className="row g-3" noValidate>
                                ...
                                <div className="col-12">
                                    {!loading && <button className="btn btn-primary" type="submit">Add Product</button>}
        ...
        <>
            ...
            <div className="row g-2 m-2">
                <div key={props.prod._id} className="col-md-4  p-2 prod_details">
                    ...
                    <span className="prod_quantity m-1"><span style={{ fontWeight: "500" }}>Products Bought:</span><span style={{ fontWeight: "bold" }}>0</span></span>
                </div>
            </div>
        </>
    )
